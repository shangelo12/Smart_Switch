    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="users.html"><i class="fa fa-user"></i>Registered Users</a></li>
            <li><a href="pages/examples/register.html"><i class="fa fa-user-plus"></i>User Registrations</a></li>
          </ul>
        </li>
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="switch.html"><i class="fa fa-toggle-on"></i> Switch</a></li>
