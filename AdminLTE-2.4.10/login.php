...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>ACS</b>ADMIN</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="login" type="submit">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
